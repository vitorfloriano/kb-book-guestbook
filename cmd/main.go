...
import (
	...
	webappv1 "github.com/vitorfloriano/kb-book-guestbook/api/v1"
	"github.com/vitorfloriano/kb-book-guestbook/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8ae70cf0.my.domain",
